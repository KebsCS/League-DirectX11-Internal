...
struct ImGui_ImplWin32_Data
{
	...
	ImGui_ImplWin32_Data() { crt::memset(this, 0, sizeof(*this)); }
};
...
bool    ImGui_ImplWin32_Init(void* hwnd)
{
	...
	std::string szBackendPlatformName = XorStr("imgui_impl_win32");
	io.BackendPlatformName = szBackendPlatformName.c_str();
...
static void ImGui_ImplWin32_UpdateGamepads()
{
	...
	ImGuiIO& io = ImGui::GetIO();
	ImGui_ImplWin32_Data* bd = ImGui_ImplWin32_GetBackendData();
	crt::memset(io.NavInputs, 0, sizeof(io.NavInputs));
