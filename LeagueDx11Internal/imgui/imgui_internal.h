...
#define ImCos(X)            crt::cosf(X)
#define ImSin(X)            crt::sinf(X)
...
struct IMGUI_API ImBitArray
{
	...
	void            ClearAllBits() { crt::memset(Storage, 0, sizeof(Storage)); }
	void            SetAllBits() { crt::memset(Storage, 255, sizeof(Storage)); }
...
struct IMGUI_API ImBitVector
{
	...
	void            Create(int sz) { Storage.resize((sz + 31) >> 5); crt::memset(Storage.Data, 0, (size_t)Storage.Size * sizeof(Storage.Data[0])); }
...
struct ImSpanAllocator
{
	...
	ImSpanAllocator() { crt::memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiComboPreviewData
{
	...
	ImGuiComboPreviewData() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiMenuColumns
{
	...
	ImGuiMenuColumns() { crt::memset(this, 0, sizeof(*this)); }
...
struct IMGUI_API ImGuiInputTextState
{
	...
	ImGuiInputTextState() { crt::memset(this, 0, sizeof(*this)); }
...
struct ImGuiPopupData
{
	...
	ImGuiPopupData() { crt::memset(this, 0, sizeof(*this)); OpenFrameCount = -1; }
};
...
struct ImGuiNextWindowData
{
	...
	ImGuiNextWindowData() { crt::memset(this, 0, sizeof(*this)); }
...
struct ImGuiNextItemData
{
	...
	ImGuiNextItemData() { crt::memset(this, 0, sizeof(*this)); }
...
struct ImGuiLastItemData
{
	...
	ImGuiLastItemData() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct IMGUI_API ImGuiStackSizes
{
	...
	ImGuiStackSizes() { crt::memset(this, 0, sizeof(*this)); }
...
struct ImGuiOldColumnData
{
	...
	ImGuiOldColumnData() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiOldColumns
{
	...
	ImGuiOldColumns() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiWindowSettings
{
	...
	ImGuiWindowSettings() { crt::memset(this, 0, sizeof(*this)); }
...
struct ImGuiSettingsHandler
{
	...
	ImGuiSettingsHandler() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiStackLevelInfo
{
	...
	ImGuiStackLevelInfo() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiStackTool
{
	...
	ImGuiStackTool() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiContextHook
{
	...
	ImGuiContextHook() { crt::memset(this, 0, sizeof(*this)); }
};
...
struct ImGuiContext
{
	...
	ImGuiContext(ImFontAtlas* shared_font_atlas)
	{
		...
		crt::memset(DragDropPayloadBufLocal, 0, sizeof(DragDropPayloadBufLocal));
		...
		crt::memset(FramerateSecPerFrame, 0, sizeof(FramerateSecPerFrame));
		FramerateSecPerFrameIdx = FramerateSecPerFrameCount = 0;
		FramerateSecPerFrameAccum = 0.0f;
		WantCaptureMouseNextFrame = WantCaptureKeyboardNextFrame = WantTextInputNextFrame = -1;
		crt::memset(TempBuffer, 0, sizeof(TempBuffer));
	}
};
...
struct ImGuiTabItem
{
	...
	ImGuiTabItem() { crt::memset(this, 0, sizeof(*this)); LastFrameVisible = LastFrameSelected = -1; NameOffset = -1; BeginOrder = IndexDuringLayout = -1; }
};
...
struct ImGuiTable
{
	...
	IMGUI_API ImGuiTable() { crt::memset(this, 0, sizeof(*this)); LastFrameActive = -1; }
...
struct ImGuiTableTempData
{
	...
	IMGUI_API ImGuiTableTempData() { crt::memset(this, 0, sizeof(*this)); LastTimeActive = -1.0f; }
};
...
struct ImGuiTableSettings
{
	...
	ImGuiTableSettings() { crt::memset(this, 0, sizeof(*this)); }
