...
static constexpr auto oChatClientPtr = 0x3109E28;// 0x30fc790;
static constexpr auto oSendChat = 0x5F49B0;// 0x5F42A0;
//static constexpr auto oPrintChat = 0x589770;
static constexpr auto oIsNotWall = 0x9ABA50;// 0x9A9570; // [actual address in first opcode] E8 ? ? ? ? 8B 0F 0F 57 C0
static constexpr auto oIsBrush = 0x9ABBB0;// 0x9A96D0; // [actual address in first opcode] E8 ? ? ? ? 8A D8 8D 44 24 18
